...
const routes: Routes = [
  ...
  { path: 'admin/customers/customer_panel/:customer_id/project_panel/:project_id/bug_view/:bug_id', component: ABugComponent, canActivate: [AuthGuard], data: { roles: ['Admin'] } },
